...
TN14 = pd.read_pickle('DATA/TN-14_C20_C30').reset_index()
...
c20 = {}
kwargs = dict(coeff_type='potential', base_dir='OUTPUT_NEW', degree=2, order=0,start_date='2000-01-01',end_date='2020-01-01')
...
c20['IGS5'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=5,
                                         **kwargs)

c20['IGS8'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=8,
                                         **kwargs)

c20['IGS8_REG'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=8,
                                         **kwargs)

# c20['ESM_GRID'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_GRIDS', degmax=5,
#                                          **kwargs)

c20['ESM'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_IGSNET', degmax=5,
                                         **kwargs)

c20['ESM_LIM'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_IGSNET_LIM', degmax=5,
                                         **kwargs)
...
c20 = gcc.filter_dataframes_dict(c20,'20000101','20200101')
...
c20_stats = plot_series_with_lombscargle(c20,'C',title='C20',units='',
                                         ...
                                         save_path=f'OUTPUT_NEW/C20_comparison{suffix}.png',
                                         y_offset=3e-10,
                                         width_cm=13,figsize=(1,1.5))

c20_signal = gcc.fit_and_provide_annual_semiannual_table_with_errors(c20,['C'])
plot_phasors(c20_signal,'C',width_cm=13,save_path=f'OUTPUT_NEW/C20_phasor{suffix}.png')

c30 = {}
kwargs = dict(coeff_type='potential', base_dir='OUTPUT_NEW', degree=3, order=0,start_date='2000-01-01',end_date='2020-01-01')

c30['TN14'] = TN14_C30

# c30['AHOS_5'] = create_coefficient_time_series(solution='IGS1R03SNX_LOAD_CRD_CF_AHOS_7D', degmax=5, **kwargs)

c30['IGS5'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=5,
                                         **kwargs)

c30['IGS8'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=8,
                                         **kwargs)

c30['IGS8_REG'] = create_coefficient_time_series(solution='IGS1R03SNX_01D', degmax=8,
                                         **kwargs)

# c30['ESM_GRID'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_GRIDS', degmax=5,
#                                          **kwargs)

c30['ESM'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_IGSNET', degmax=5,
                                         **kwargs)

c30['ESM_LIM'] = create_coefficient_time_series(solution='ESMGFZ_H_cf_IGSNET_LIM', degmax=5,
                                         **kwargs)

c30 = gcc.filter_dataframes_dict(c30,'20000101','20200101')
c30 = gcc.resample_and_interpolate(c30,'1D')

c30_stats = plot_series_with_lombscargle(c30,'C',title='C30',units='',
                                         apply_lowpass_filter=apply_lowpass_filter,
                                         save_path=f'OUTPUT_NEW/C30_comparison{suffix}.png',
                                         y_offset=3e-10,
                                         width_cm=13,figsize=(1,1.5))

c30_signal = gcc.fit_and_provide_annual_semiannual_table_with_errors(c30,['C'])
plot_phasors(c30_signal,'C',width_cm=13,save_path=f'OUTPUT_NEW/C30_phasor{suffix}.png')
#
# c20_load = {}
